...
public class ModItems {
    ...
    public static final Map<PigmentColor, DeferredItem<Item>> pigmentItems = new TreeMap<>(ModItems::compare);
    public static final Map<PigmentColor, DeferredItem<Item>> bannerItems = new TreeMap<>(ModItems::compare);
